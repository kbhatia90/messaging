...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Button preferenceButton = findViewById(R.id.preferencesButton);
        ...
        /*Button pushTokenButton = findViewById(R.id.pushTokenButton);
        pushTokenButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Get token
                String token = FirebaseInstanceId.getInstance().getToken();
                MyUser myUser = new MyUser(FirebaseInstanceId.getInstance().getId().toString(),FirebaseInstanceId.getInstance().getToken().toString(),mUserName);
